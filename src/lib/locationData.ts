...
export const CITY_DATA: Record<string, CityData> = {
  mumbai: {
    ...
    stampDutyPct: 6,
    registrationPct: 1,
    avgRentalYieldPct: 2.8,
    propertyTaxPct: 0.3,
    avgAppreciationRange: [5, 7],
    bachelorFriendliness: 3,
    avgSafetyIndex: 3.5,
    avgLiquidityScore: 4,
    avgRentDepositMonths: 3,
    brokerageBuyPct: 1,
    brokerageRentMonths: 2,
    avgCommutePerKmMonthly: 350,
  },
  delhi: {
    label: 'Delhi NCR',
    stampDutyPct: 6,
    registrationPct: 1,
    avgRentalYieldPct: 2.5,
    propertyTaxPct: 0.5,
    avgAppreciationRange: [4, 6],
    bachelorFriendliness: 2,
    avgSafetyIndex: 3,
    avgLiquidityScore: 3.5,
    avgRentDepositMonths: 3,
    brokerageBuyPct: 1,
    brokerageRentMonths: 1,
    avgCommutePerKmMonthly: 300,
  },
  bengaluru: {
    label: 'Bengaluru',
    stampDutyPct: 5.6,
    registrationPct: 1,
    avgRentalYieldPct: 3.2,
    propertyTaxPct: 0.2,
    avgAppreciationRange: [6, 8],
    bachelorFriendliness: 4,
    avgSafetyIndex: 4,
    avgLiquidityScore: 4,
    avgRentDepositMonths: 10,
    brokerageBuyPct: 1,
    brokerageRentMonths: 1,
    avgCommutePerKmMonthly: 280,
  },
  hyderabad: {
    label: 'Hyderabad',
    stampDutyPct: 5.5,
    registrationPct: 0.5,
    avgRentalYieldPct: 3.5,
    propertyTaxPct: 0.25,
    avgAppreciationRange: [7, 9],
    bachelorFriendliness: 3.5,
    avgSafetyIndex: 3.5,
    avgLiquidityScore: 3.5,
    avgRentDepositMonths: 3,
    brokerageBuyPct: 1,
    brokerageRentMonths: 1,
    avgCommutePerKmMonthly: 250,
  },
  pune: {
    label: 'Pune',
    stampDutyPct: 6,
    registrationPct: 1,
    avgRentalYieldPct: 3.0,
    propertyTaxPct: 0.3,
    avgAppreciationRange: [5, 7],
    bachelorFriendliness: 4,
    avgSafetyIndex: 4,
  ...
  chennai: {
    ...
    propertyTaxPct: 0.4,
    avgAppreciationRange: [4, 6],
    bachelorFriendliness: 2.5,
    avgSafetyIndex: 3.5,
    avgLiquidityScore: 3,
    avgRentDepositMonths: 6,
    brokerageBuyPct: 1,
    brokerageRentMonths: 1,
    avgCommutePerKmMonthly: 250,
  },
  ...
  kolkata: {
    ...
    avgRentalYieldPct: 3.0,
    propertyTaxPct: 0.4,
    avgAppreciationRange: [3, 5],
    bachelorFriendliness: 3,
    avgSafetyIndex: 3,
    avgLiquidityScore: 2.5,
    avgRentDepositMonths: 3,
    brokerageBuyPct: 1,
    brokerageRentMonths: 1,
    avgCommutePerKmMonthly: 200,
  },
  gurgaon: {
    label: 'Gurgaon',
    stampDutyPct: 7,
